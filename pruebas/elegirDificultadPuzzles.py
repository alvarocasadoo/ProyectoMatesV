...
label_text = "Elige la dificultad del puzzle"
            ...
            for i, button_text in enumerate(button_texts):
                ...
                if button_rect.collidepoint(x, y):
                    ...
                    if button_text == "Fácil":
                        import puzzleFacil  
                        puzzleFacil.main()  # Llamar a la función main() del script problemasFacil.py
                    elif button_text == "Media":
                        import puzzleMedio 
                        puzzleMedio.main()  # Llamar a la función main() del script problemasMedia.py
                    elif button_text == "Difícil":
                        import puzzleDificil  
                        puzzleDificil.main()  # Llamar a la función main() del script problemasDificil.py
