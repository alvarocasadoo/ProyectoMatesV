...
label_text = "Elige la dificultad del juego de memoria"
            ...
            for i, button_text in enumerate(button_texts):
                ...
                if button_rect.collidepoint(x, y):
                    ...
                    if button_text == "Fácil":
                        import memoriaFacil
                        memoriaFacil.main()  # Llamar a la función main() del script problemasFacil.py
                    elif button_text == "Media":
                        import memoriaMedio
                        memoriaMedio.main()  # Llamar a la función main() del script problemasMedia.py
                    elif button_text == "Difícil":
                        import memoriaDificil
                        memoriaDificil.main()  # Llamar a la función main() del script problemasDificil.py
