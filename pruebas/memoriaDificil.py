...
# Mostrar la secuencia de números durante menos tiempo (0.5 segundos)
for numero in secuencia_numeros:
    ...
    pygame.display.flip()
    time.sleep(0.5)  # Mostrar cada número durante 0.5 segundos
...
pantalla.fill(BLANCO)
fuente_resultado = pygame.font.Font(None, 36)  # Tamaño de la fuente más pequeño (36)
