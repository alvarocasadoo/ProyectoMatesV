...
# Generar una secuencia aleatoria de números más larga (10 números en total)
for i in range(10):
...
input_secuencia = []
for numero in secuencia_numeros:
    while len(input_secuencia) < len(secuencia_numeros):  # Salir del bucle cuando se hayan ingresado todos los números
...
# Mostrar mensaje de resultado en pantalla con texto más pequeño
pantalla.fill(BLANCO)
fuente_resultado = pygame.font.Font(None, 30)  # Tamaño de la fuente más pequeño (30)
